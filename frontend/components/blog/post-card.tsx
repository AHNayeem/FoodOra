 ...
 *
 * A client component since C26: the blog index and the article reader re-read
 * their posts from the CMS after hydration, and a server component cannot be
 * rendered inside that tree.
 */
