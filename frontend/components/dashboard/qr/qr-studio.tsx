...
import type { QrMenuConfig, QrTarget, TableZone } from "@/frontend/types";
import { useDashboard } from "@/frontend/components/dashboard/dashboard-context";
import { getQrMenuConfig, getQrTargets } from "@/frontend/services/qr";
import { qrFileSlug } from "@/frontend/lib/qr";
import { QrCode, qrPngDataUrl, qrSvgMarkup } from "@/frontend/components/qr/qr-code";
